...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100">
      {/* Left Side: Promotional Content with Card */}
      <div className="w-1/2 flex justify-center items-center p-16">
        <div className="bg-white shadow-md rounded-lg p-8">
          ...
          <img
            src={Logo}
            alt="Logo"
            className="mb-8 mx-auto" // Center the logo within the card
            style={{ width: "150px", height: "150px" }} // Adjusted logo size for the card
          />
          ...
          <p className="text-gray-700 text-lg leading-relaxed text-center">
            Afyangu simplifies medical record management, insurance tracking,
            and health monitoring. Seamlessly organize your healthcare data,
