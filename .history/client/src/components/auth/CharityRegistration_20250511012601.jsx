...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Styled with increased padding and blue button with spacing) */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5 w-4/5 mx-auto">
            ...
            <button
              type="submit"
              className="w-full mt-6 bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 transition font-sans" // Added mt-6 here
            >
              Proceed
            </button>
