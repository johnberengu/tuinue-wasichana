...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100">
      ...
      {/* Right Side: Registration Form within a Card (Transparent Fields with Reduced Width) */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          className="bg-white shadow-md rounded-lg p-10 w-full flex flex-col items-center" // Added flex and items-center
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-4/5">
            ...
            <div>
              ...
              <div className="flex">
                ...
                <input
                  className="shadow appearance-none border rounded-r-md w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm bg-transparent"
                  id="phone"
                  type="tel"
                  name="phone"
          ...
          <div className="flex flex-col items-center mt-6 w-4/5">
            {" "}
            {/* Center the button and link */}
            <button
