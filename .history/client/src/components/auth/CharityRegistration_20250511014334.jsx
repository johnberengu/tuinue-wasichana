            ...
            >
              <div className="w-full">
                ...
                <input
                  ...
                  required
                  className="w-full mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans text-gray-900" // Added text-gray-900
                />
              </div>
              <div className="w-full">
              ...
              <div className="w-full">
                ...
                <input
                  ...
                  } text-gray-900`} // Added text-gray-900
                />
              </div>
              <div className="w-full">
