...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Attempting Centering with Flexbox) */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        ...
        >
          ...
          <div className="w-4/5 flex flex-col items-stretch">
            {" "}
            {/* Using items-stretch to make children take full width */}
            ...
            <div className="w-full flex justify-center">
              {" "}
              {/* Center the button and link horizontally */}
              <button
                type="submit"
                style={{ marginTop: "30px" }}
                className="w-full sm:w-auto bg-blue-600 text-white py-3 px-6 rounded-md font-semibold hover:bg-blue-700 transition font-sans" // Added sm:w-auto and px-6
              >
                Proceed
              </button>
            </div>
