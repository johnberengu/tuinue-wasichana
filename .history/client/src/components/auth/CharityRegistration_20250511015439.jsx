  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          className="bg-white shadow-md rounded-lg p-10 w-full flex flex-col items-center text-center" // Added text-center here for the subheading
            ...
            >
              <div className="w-full flex flex-col items-center">
                ...
                <input
                  ...
                  required
                  className="mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans text-gray-900 text-center"
                  style={{ width: "90%" }} // Increased width to 90%
                />
              </div>
              <div className="w-full flex flex-col items-center">
                {" "}
              ...
              >
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 transition font-sans" // Full width button
                >
                  Proceed
                </button>
              </div>
