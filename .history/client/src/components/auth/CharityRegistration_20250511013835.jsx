...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Attempting Explicit Centering Correctly) */}
        ...
        >
          ...
          <div className="w-4/5">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full sm:w-auto bg-blue-600 text-white py-3 px-6 rounded-md font-semibold hover:bg-blue-700 transition font-sans"
              >
                Proceed
              </button>
            </div>
