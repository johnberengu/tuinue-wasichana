...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100">
      ...
      {/* Right Side: Registration Form within a Card (Styled) */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          className="bg-white shadow-md rounded-lg p-10 w-full" // Increased padding
        ...
        >
          ...
          <p className="text-gray-600 text-lg mb-10 text-center">
            {" "}
            {/* Larger paragraph with more margin */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm" // Increased input padding
              >
            ...
            <div>
              ...
              <div className="flex">
                ...
                <input
                  className="shadow appearance-none border rounded-r-md w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm" // Increased input padding
                  id="phone"
                  type="tel"
                  name="phone"
            ...
            <div className="flex flex-col space-y-4">
              ...
              <button
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded focus:outline-none focus:shadow-outline w-full text-lg transition duration-300" // Larger button
                type="submit"
              >
                Register
              </button>
              <p className="text-gray-600 text-sm mt-0 text-center">
