...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Styled with new fields) */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 w-4/5 mx-auto">
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-1 px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-2 rounded-md font-semibold hover:bg-blue-700 transition font-sans"
            >
              Proceed
            </button>
