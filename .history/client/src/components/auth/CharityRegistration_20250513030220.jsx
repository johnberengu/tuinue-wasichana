            ...
            >
              ...
              <div className="w-full flex flex-col items-center">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={2}
                  className="mt-1 px-3.5 py-2.5 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans text-gray-900 resize-none text-xs" // Increased padding
                  style={{ width: "90%" }}
                />
              </div>
              ...
              <div
                style={{
                  marginTop: "17.5px", // Increased marginTop
                  display: "flex",
