...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100">
      ...
      {/* Right Side: Registration Form within a Card (Transparent Fields) */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <select
                ...
                className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm bg-transparent" // Added bg-transparent
              >
            ...
            <div>
              ...
              <input
                className={`shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm bg-transparent ${
            ...
            <div>
              ...
              <div className="flex">
                ...
                <input
                  className="shadow appearance-none border rounded-r-md w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm bg-transparent" // Added bg-transparent
                  id="phone"
                  type="tel"
                  name="phone"
