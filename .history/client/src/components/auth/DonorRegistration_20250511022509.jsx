...
const DonorRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      {/* Left Side: Promotional Content (You can customize this for donors) */}
      <div className="w-1/2 flex flex-col justify-center items-center p-16 bg-gradient-to-br from-blue-100 to-blue-300">
        ...
        <p className="text-gray-700 text-lg leading-relaxed mb-8 text-center">
          Join our community of compassionate individuals making a difference.
          Your contribution helps us further our mission and create a lasting
          impact.
        </p>
      </div>
      ...
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          ...
          style={{ maxWidth: "700px", minHeight: "650px" }}
        >
          <h3 className="text-2xl font-semibold text-gray-900 mb-2 text-center">
            Donor Registration
          </h3>
          <p className="text-gray-600 text-sm mb-6 text-left">
            Enter your details below to become a donor
          </p>
          <div className="w-4/5">
            <form
