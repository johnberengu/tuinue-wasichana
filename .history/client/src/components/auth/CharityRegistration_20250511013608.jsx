...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Attempting to Center with place-items-center) */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          className="bg-white shadow-md rounded-lg p-10 w-full flex flex-col place-items-center text-center" // Replaced items-center with place-items-center
        ...
        >
          ...
          <div className="w-4/5">
            {" "}
            {/* Removed mx-auto here to let place-items-center work */}
            <form
              onSubmit={handleSubmit}
              className="space-y-5 w-full flex flex-col"
            >
              {" "}
              {/* Adjusted form to flex column */}
