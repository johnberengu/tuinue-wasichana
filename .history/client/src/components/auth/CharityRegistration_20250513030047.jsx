  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      <div className="w-1/2 flex flex-col justify-center items-center p-10 bg-gradient-to-br from-blue-100 to-blue-300">
        ...
        />
        <h2 className="text-xl font-bold text-blue-900 mb-3 text-center font-semibold">
          {" "}
          Empowering Girls with Tuinue Wasichana
        </h2>
        <p className="text-gray-900 text-md leading-relaxed mb-4 text-center text-sm">
          {" "}
      ...
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          className="bg-white shadow-md rounded-lg p-6 w-full flex flex-col items-center text-center"
