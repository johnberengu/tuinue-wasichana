    ...
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        <div
          ...
          style={{ maxWidth: '800px', minHeight: '800px' }} // Changed maxHeight to minHeight
        >
          ...
          <div className="w-4/5">
            <form
              ...
              style={{ margin: '0 auto' }}
            >
              <div className="w-full flex flex-col items-center"> {/* Centering label and input */}
                <label className="text-sm text-gray-700 w-full text-left">Charity Name</label> {/* Left-align label */}
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div className="w-full flex flex-col items-center"> {/* Centering label and input */}
                <label className="text-sm text-gray-700 w-full text-left">Email</label> {/* Left-align label */}
                <input
                  type="email"
                  name="email"
              ...
              <div className="w-full flex flex-col items-center"> {/* Centering label and input */}
                <label className="text-sm text-gray-700 w-full text-left">Username</label> {/* Left-align label */}
                <input
                  type="text"
                  name="username"
              ...
              <div className="w-full flex flex-col items-center"> {/* Centering label and input */}
                <label className="text-sm text-gray-700 w-full text-left">Password</label> {/* Left-align label */}
                <input
                  type="password"
                  name="password"
              ...
              <div className="w-full flex flex-col items-center"> {/* Centering label and input */}
                <label className="text-sm text-gray-700 w-full text-left">Phone Number</label> {/* Left-align label */}
                <input
                  type="tel"
                  name="phone"
