...
import Logo from "../../assets/logo.svg"; // Ensure you have the correct logo
...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      {/* Left Side: Promotional Content (Styling can be further enhanced) */}
      <div className="w-1/2 flex flex-col justify-center items-start p-16 bg-gradient-to-br from-blue-100 to-blue-300">
        ...
        {/* Consider adding an image here for visual appeal */}
      </div>

      {/* Right Side: Registration Form (Maximum Styling) */}
      <div className="w-1/2 flex flex-col justify-center items-center bg-white p-12 md:p-16 shadow-xl">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex">
                <span className="inline-flex items-center px-4 rounded-l-md border border-r-0 border-gray-300 bg-gray-100 text-gray-500 text-sm">
                  +254
                </span>
                <input
