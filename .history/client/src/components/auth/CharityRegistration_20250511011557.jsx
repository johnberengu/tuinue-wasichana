...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card */}
      <div className="w-1/2 flex justify-center items-center bg-blue-100">
        ...
        >
          <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center font-semibold">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-4/5 mx-auto">
            <div>
              ...
              >
                <option className="font-sans">National ID</option>
            ...
            <div>
              ...
              />
              {!usernameAvailable && (
                <p className="text-red-500 text-xs italic mt-1 font-sans">
            ...
            <div>
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-100 text-gray-500 text-sm font-sans">
                  +254
                </span>
                <input
                  className="shadow appearance-none border rounded-r-md w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm bg-transparent font-sans"
                  id="phone"
                  type="tel"
                  name="phone"
          ...
          <div className="flex flex-col items-center mt-6 w-4/5 mx-auto">
            <button
              className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded focus:outline-none focus:shadow-outline w-full text-lg transition duration-300 font-sans"
              type="submit"
            >
              Register
            </button>
            <p className="text-gray-600 text-sm mt-4 text-center font-sans">
              Already have an account?
              <span
                onClick={() => navigate("/login")}
                className="text-blue-500 hover:underline cursor-pointer ml-1 font-sans"
              >
                Sign In
              </span>
            </p>
