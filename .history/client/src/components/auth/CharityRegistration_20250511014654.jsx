            ...
            >
              <div className="w-full flex flex-col items-center">
                ...
                <input
                  ...
                  required
                  className="w-4/5 mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans text-gray-900 text-center" // Center input text
                />
              </div>
              <div className="w-full flex flex-col items-center">
                {" "}
              ...
              <div className="w-full flex flex-col items-center">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className={`w-4/5 mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans ${
              ...
              >
                <button
                  type="submit"
                  className="w-4/5 bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 transition font-sans" // Match input width
                >
                  Proceed
                </button>
              </div>
