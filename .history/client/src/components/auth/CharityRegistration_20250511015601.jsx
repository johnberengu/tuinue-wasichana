            ...
            >
              <div className="w-full flex flex-col items-center">
                ...
                <input
                  ...
                  required
                  className="mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans text-gray-900" // Removed text-center
                  style={{ width: "90%" }}
                />
              </div>
              <div className="w-full flex flex-col items-center">
              ...
              <div className="w-full flex flex-col items-center">
                ...
                <input
                  ...
                  } text-gray-900`} // Removed text-center
                  style={{ width: "90%" }}
                />
              </div>
              <div className="w-full flex flex-col items-center">
