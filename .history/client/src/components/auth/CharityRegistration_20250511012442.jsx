...
const CharityRegistration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-100 font-sans">
      ...
      {/* Right Side: Registration Form within a Card (Styled with increased padding and blue button) */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 w-4/5 mx-auto">
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-1 px-6 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-transparent font-sans" // Increased px and py
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 transition font-sans" // Increased py and kept blue color
            >
              Proceed
            </button>
