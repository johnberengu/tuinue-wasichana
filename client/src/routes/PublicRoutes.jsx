...
// import CharityRegistration from '../pages/public/charity/CharityRegistrationPage';
import DonorRegistration from '../pages/public/DonorRegistration';
...
const PublicRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="charitydashbord" element={<CharityDashboard />} />
